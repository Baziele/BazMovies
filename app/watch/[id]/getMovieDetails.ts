...
export async function getMovieDetails(id: string) {
    const url = `https://api.themoviedb.org/3/movie/${id}?append_to_response=videos%2Cimages%2Csimilar%2Ccredits&language=en-US`;
    const options = {
        method: "GET",
        headers: {
    ...
    const movie: Movie = {
        ...
        videoUrl: `https://vidsrc.me/embed/movie?tmdb=${movieData.id}`,
